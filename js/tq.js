...
document.body.onload = function () {
  ...
  var t2d = [
    document.getElementById("t2d1"),
    document.getElementById("t2d2"),
    document.getElementById("t2d3"),
  ];
  ...
  var h2d = [
    document.getElementById("h2d1"),
    document.getElementById("h2d2"),
    document.getElementById("h2d3"),
  ];
  var h3 = document.getElementById("h3");
  var h3d = [
    document.getElementById("h3d1"),
  ...
  uline.to(u1, 0.5, { strokeDashoffset: 0, ease: Quad.easeInOut }, 0);
  ...
  if (tspans[0].dx.baseVal[0]) {
    textTl.to(
      tspans[0].dx.baseVal[0],
      0.6,
      { value: 0, ease: Cubic.easeOut },
      1
    );
    textTl.to(
      tspans[0].dy.baseVal[0],
      0.6,
      { value: -1, ease: Cubic.easeOut },
      1
    );
  } else {
  ...
  function addLineDecTween(tl, line, duration, x, y, delay) {
    tl.to(
      line.x2.baseVal,
      duration,
      { value: x, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.y2.baseVal,
      duration,
      { value: y, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.x1.baseVal,
  ...
  function addLineDecOutTween(tl, line, duration, x1, y1, x2, y2, delay) {
    tl.to(
      line.x1.baseVal,
      duration,
      { value: x1, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.y1.baseVal,
      duration,
      { value: y1, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.x2.baseVal,
      duration,
      { value: x2, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.y2.baseVal,
      duration,
      { value: y2, ease: Quart.easeInOut },
      delay
    );
    tl.to(
      line.x1.baseVal,
  ...
  function addUnderlineTween(tl, ul, duration, x2, y2, x1, y1, delay) {
    ...
    tl.to(
      ul.x1.baseVal,
      duration,
      { value: x1, ease: Quad.easeInOut },
      delay + duration
    );
    tl.to(
      ul.y1.baseVal,
      duration,
      { value: y1, ease: Quad.easeInOut },
      delay + duration
    );
  }
